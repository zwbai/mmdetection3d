...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[[-51.2, -51.2, -2.6, 51.2, 51.2, -2.6],
...
db_sampler = dict(
    ...
    sample_groups=dict(Car=15, Pedestrian=10, Cyclist=6))
...
train_pipeline = [
    ...
    dict(type='DefaultFormatBundle3D', class_names=['Pedestrian', 'Car']),
...
log_level = 'INFO'
work_dir = './work_dirs/hv_pointpillars_carla-kitti-3d-2class_roadside'
load_from = None
resume_from = None
workflow = [('train', 1)]
gpu_ids = [0]
