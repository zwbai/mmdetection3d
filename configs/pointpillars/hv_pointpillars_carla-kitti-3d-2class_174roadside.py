...
model = dict(
    ...
    voxel_layer=dict(
        max_num_points=32,
        point_cloud_range=[-51.2, -51.2, -2.5, 51.2, 51.2, 2.5],
        voxel_size=[0.2, 0.2, 5],
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[[-51.2, -51.2, -0.6, 51.2, 51.2, -0.6],
...
log_level = 'INFO'
work_dir = './work_dirs/hv_pointpillars_carla-kitti-3d-2class_174roadside'
load_from = None
resume_from = None
workflow = [('train', 1)]
gpu_ids = [0]
