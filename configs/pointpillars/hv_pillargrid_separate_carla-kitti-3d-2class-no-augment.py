_base_ = [
    '../_base_/models/hv_pillargrid_separate_secfpn_kitti_carla.py',
...
train_pipeline = [
    dict(type='LoadPointsFromMultipleFile', coord_type='LIDAR', load_dim=4, use_dim=4),
